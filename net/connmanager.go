...
type ConnManager struct {
	connections map[uint32]service.IConnection
...
func NewConnManager() *ConnManager {
	return &ConnManager{
		connections: make(map[uint32]service.IConnection),
	}
}

//Add 添加链接
func (connMgr *ConnManager) Add(conn service.IConnection) {
...
//Remove 删除连接
func (connMgr *ConnManager) Remove(conn service.IConnection) {
...
//Get 利用ConnID获取链接
func (connMgr *ConnManager) Get(connID uint32) (service.IConnection, error) {
