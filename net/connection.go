...
func NewConnection(server service.IServer, conn *net.TCPConn, connID uint32, msgHandler service.IMsgHandle) *Connection {
	//初始化Conn属性
	c := &Connection{
		TCPServer:   server,
		Conn:        conn,
...
func NewWsConnection(server service.IServer, conn *websocket.Conn, connID uint32, msgHandler service.IMsgHandle) *Connection {
	//初始化Conn属性
	c := &Connection{
		TCPServer:   server,
		WsConn:      conn,
